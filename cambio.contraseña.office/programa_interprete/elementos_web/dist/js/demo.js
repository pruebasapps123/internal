...
(function ($) {
  ...
  $container.append(
    '<h5>Editar MJ Reports</h5><hr class="mb-2"/>'
  )
  ...
  $container.append('<h6>Opciones Header</h6>')
  ...
  var $no_border_container = $('<div />', { class: 'mb-4' }).append($no_border_checkbox).append('<span>Sin borde</span>')
  $container.append($no_border_container)

  $container.append('<h6>Opciones sidebar</h6>')
  ...
  var $flat_sidebar_container = $('<div />', { class: 'mb-1' }).append($flat_sidebar_checkbox).append('<span>Nav estilo Flat</span>')
  ...
  var $legacy_sidebar_container = $('<div />', { class: 'mb-1' }).append($legacy_sidebar_checkbox).append('<span>Nav estilo Legacy</span>')
  ...
  var $compact_sidebar_container = $('<div />', { class: 'mb-4' }).append($compact_sidebar_checkbox).append('<span>Nav Compacto</span>')
  ...
  $container.append('<h6>Opciones Footer</h6>')
  ...
  $container.append('<h6>Textos pequeños</h6>')
  ...
  var $text_sm_header_container = $('<div />', { class: 'mb-1' }).append($text_sm_header_checkbox).append('<span>Nav superior</span>')
  ...
  var $text_sm_sidebar_container = $('<div />', { class: 'mb-1' }).append($text_sm_sidebar_checkbox).append('<span>Nav lateral</span>')
